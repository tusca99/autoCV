...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
        \textbf{Bachelor thesis --- Water's surface potential reproduction with Neural Network} & \hfill \url{https://github.com/tusca99/Bachelor-Thesis} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline        
        \textbf{N-body simulation} & \hfill \url{https://github.com/tusca99/N-body-simulation} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline
        \textbf{Fine--Grained Vehicle Recognition with CNNs} & \hfill \url{https://github.com/tusca99/Cars-classification-using-CNN} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline
    \textbf{Hopfield Neural Network} & \hfill \url{https://github.com/tusca99/Hopfield-Model} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline
    \textbf{Distributed K-Means with Dask} & \hfill \url{https://github.com/tusca99/Distributed-K-Means-Dask} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline
    \textbf{Simulation-Based Inference for a 2D random walk model} & \hfill \url{https://github.com/tusca99/PoD-LACP-B} \\[3.75pt]
...
\arrayrulecolor{gray!30}\hline
    \textbf{Bayesian Analysis of ARPAV time series} & \hfill \url{https://github.com/tusca99/Bayesian-Analysis-ARPAV-Temperature-Time-Series} \\[3.75pt]
...
HPC and parallelism  &  \normalsize{Asyncio, Dask, Numba, MPI, OpenMP}\\
